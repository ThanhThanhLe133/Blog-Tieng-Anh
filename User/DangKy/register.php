...
<body>
    ...
    <main>
	<form method="post" action="ThemTaiKhoan.php" id="registerForm">
		...
		<div class="mb-4">
                    <label class="block text-gray-700 text-sm font-bold mb-2" for="phoneNumber">Số điện thoại</label>
                ...
                <div class="mb-4">
                    <label class="block text-gray-700 text-sm font-bold mb-2" for="confirm_password">Nhập lại mật khẩu</label>
