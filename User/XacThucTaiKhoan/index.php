                        ...
                        <ul class="nav__list">
                            ...
                            <li class="nav__item">
                                ...
                                <ul class="nav__submenu course-list">
                                    <li class="submenu__item"><a class="submenu__link"
                                            href="../../web/Demo day/index.html">Học
                                            thử miễn phí</a>
                                    </li>
                                    <li class="submenu__item"><a class="submenu__link"
                                            href="../../web/1-2/index.html">Khóa học
                                            cho trẻ 1-2
                                            tuổi</a></li>
                                    <li class="submenu__item"><a class="submenu__link"
                                            href="../../web/3-8/index.html">Khóa học
                                            cho trẻ 3-8
                                            tuổi</a></li>
                                    <li class="submenu__item"><a class="submenu__link"
                                            href="../../web/9-12/index.html">Khóa
                                            học cho trẻ
                                            9-12
                                            tuổi</a></li>
                                    <li class="submenu__item"><a class="submenu__link"
                                            href="../../web/13-18/index.html">Khóa
                                            học cho trẻ
                                            13-18
                                            tuổi</a></li>
                                </ul>
                            ...
                            <li class="nav__item">
                                ...
                                <ul class="nav__submenu blog">
                                    <li class="submenu__item children_English"><a class="submenu__link"
                                            href="../../web/blog/BlogTaTreEm/listblog/index.html">Tiếng
                                            Anh trẻ em</a></li>
                                    <li class="submenu__item raise-children"><a class="submenu__link"
                                            href="../../web/blog/BlogNuoiDayCon/listblog/index.html">Nuôi dạy
                                            con</a></li>
                                    <li class="submenu__item news"><a class="submenu__link"
                                            href="../../web/blog/BlogTinTucSuKien/listblog/index.html">Tin tức - Sự
                                            kiện</a></li>
                                </ul>
                            </li>
                        </ul>
            ...
            <div class="w-3/4 bg-white p-8 ml-8 shadow-lg">
                ...
                <div class="mb-4">
                    ...
                    <input
                        ...
                        id="email" name="email" placeholder="Nhập email đã đăng ký với tài khoản" type="email" required>
                </div>

                <!-- Nút gửi mã xác thực -->
                <div class="send-code">
                    <button type="submit" id="sendCode" name="sendCode"
                ...
                <!-- Nhập mã xác thực -->
                <div class="mb-4 mt-4">
                    <label class="block text-gray-700 text-sm font-bold mb-2" for="verification-code">Mã xác
                        thực</label>
                    <input
                        class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                        id="verification-code" name="verification_code" placeholder="Nhập mã xác thực" type="text"
                        required>
                </div>

                <div class="flex items-center justify-between">
                    <button class="bg-gray-800 text-white py-2 px-4 rounded hover:bg-gray-700" type="submit"
