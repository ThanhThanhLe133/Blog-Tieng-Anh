...
$sql = "SELECT * FROM blogs WHERE category_id = 1 ORDER BY created_at DESC LIMIT $items_per_page OFFSET $offset";
...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
            ...
            $html .= "
            <div class='bg-white rounded-lg shadow-md mb-6' data-id='{$row['blog_id']}'>
                <div class='flex'>
                    ...
                    <p class='text-gray-700 mb-4'>" . substr($row['content'], 0, 150) . "...</p>
