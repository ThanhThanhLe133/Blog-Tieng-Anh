...
$sql = "
    (SELECT * FROM blogs WHERE category_id = 2 AND blog_id < $blog_id ORDER BY blog_id DESC LIMIT 2)
    UNION
    (SELECT * FROM blogs WHERE category_id = 2 AND blog_id > $blog_id ORDER BY blog_id ASC LIMIT 2)
";
